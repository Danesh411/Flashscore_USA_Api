def baseketball_extract(event_url, data_elements):
    import requests
    ...
    for data_element in data_elements:
        ...
        # Get valid match rows only (exclude static headers)
        ...
        for match_idx in range(len(match_rows)):
            ...
            # Team names (getall() because sometimes split into spans)
            ...
            # Build partial result (venue to be filled later)
            result_dict.update({
                "link": event_url,
                "sport": "basketball",
                ...
                "Team 1 Inning/quater wise score": " ".join(home_team_inning_score) if home_team_inning_score else None,
